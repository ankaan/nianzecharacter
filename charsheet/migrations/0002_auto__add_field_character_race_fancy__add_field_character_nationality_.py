...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.race_fancy'
        db.add_column('charsheet_character', 'race_fancy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Character.nationality_fancy'
        db.add_column('charsheet_character', 'nationality_fancy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.race_fancy'
        db.delete_column('charsheet_character', 'race_fancy')

        # Deleting field 'Character.nationality_fancy'
        db.delete_column('charsheet_character', 'nationality_fancy')
